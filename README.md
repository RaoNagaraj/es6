...
* It's the first ECMAScript Harmony specification and is also known as `ES Harmony`, `ES2015`, `ES.next` but commonly referred to as `ES6`
* Subsequent versions will be released on a 12 month cadence, and will be named `ES7`, `ES2015` respectively 
